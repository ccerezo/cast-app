<div>
    <div class="flex justify-between border-b border-gray-300 pb-2 mb-3 shadow ">
        ...
        <a href="{{route('materiaPrimas.create')}}" class="inline-flex items-center mt-4 mr-5 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-100 bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    ...
                    <table class="min-w-full">
                        ...
                        @foreach ($materiasPrimas as $materiaPrima)
                            ...
                            <td class="px-2 py-2 whitespace-nowrap">
                                <a href="{{route('materiaPrimas.edit', $materiaPrima)}}" class="mr-3 text-indigo-600 hover:text-indigo-800">Editar</a>
                            </td>
                            <td class="px-2 pt-0 whitespace-nowrap">
                                <form action="{{route('materiaPrimas.destroy', $materiaPrima)}}" method="POST">
                                    @csrf
                                    @method('delete')
