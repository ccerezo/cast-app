<div>
    <div class="flex justify-between">
        <p class="inline-flex mt-4 pl-5 text-lg text-gray-700">Listado de Tallas</p>
        <a href="{{route('tallas.create')}}" class="inline-flex items-center mt-4 mr-5 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-100 bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            Agregar Talla
        </a>
    </div>
                    ...
                    <table class="min-w-full">
                        ...
                        @foreach ($tallas as $talla)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{route('tallas.edit', $talla)}}" class="mr-3 text-indigo-600 hover:text-indigo-800">Editar</a>
                            </td>
                            <td>
