<div>
    <div class="flex justify-between">
        <p class="inline-flex mt-4 pl-5 text-lg text-gray-700">Modelos de calzado</p>
                        ...
                        <table class="min-w-full">
                            ...
                            @foreach ($modelos as $modelo)
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{route('modelos.edit', $modelo)}}" class="mr-3 text-indigo-600 hover:text-indigo-800">Editar</a>
                                </td>
                                <td>
