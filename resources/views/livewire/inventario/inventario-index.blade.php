<div>
    <div class="flex justify-between">
        ...
        @if ($searchCodigoBarras && $searchColor)
        <a href="{{route('pdf.reporteInventarioFiltradoPDF', [$searchCodigoBarras, $searchColor])}}" target="_blank" class="inline-flex items-center px-4 py-2 mt-4 mr-5 text-sm font-medium text-gray-100 bg-blue-700 border border-gray-300 rounded-md shadow-sm hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
