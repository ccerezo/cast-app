    ...
    <div class="mt-10 p-5 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Editar las tallas de calzado, En número principal los número por Ej. de 20 hasta 45
                        En número secundario es opcional, se pueda agregue el quivalente de la talla en Americano
                    </p>
                </div>
            </div>
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                @endif
                {!! Form::model($talla, ['route' => ['tallas.update', $talla], 'method' => 'put']) !!}
                <div class="shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                {!! Form::label('name', 'Número Principal', ['class' => 'block text-sm font-medium text-gray-700']) !!}
                                {!! Form::text('numero1', null, ['class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md']) !!}
                                @error('numero1')
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                {!! Form::label('name', 'Número Secundario', ['class' => 'block text-sm font-medium text-gray-700']) !!}
                                {!! Form::text('numero2', null, ['class' => 'mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md']) !!}
                                @error('numero2')
                                    <span class="mt-2 text-sm text-red-500">{{$message}}</span>
                                @enderror
                            </div>
