    ...
    <div class="mt-10 p-5 sm:mt-0">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Editar los tipos de linea que se les va asignar a los productos.
                    </p>
                </div>
            </div>
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                @endif
                {!! Form::model($linea, ['route' => ['lineas.update', $linea], 'method' => 'put']) !!}
                <div class="shadow overflow-hidden sm:rounded-md">
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                        <a href="{{route('lineas.index')}}" class="inline-flex items-center mt-4 mr-5 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-900 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Regresar
                        </a>
